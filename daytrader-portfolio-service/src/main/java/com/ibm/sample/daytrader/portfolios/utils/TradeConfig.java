 ...
 */
package com.ibm.sample.daytrader.portfolios.utils;
...
public class TradeConfig {
    ...
    private static String getHostname() {
        try {
            ...
            com.ibm.sample.daytrader.portfolios.utils.Log.error(
    ...
    public static String rndUserID() {
        ...
        if (com.ibm.sample.daytrader.portfolios.utils.Log.doTrace())

...
<%@ page
    import="java.util.Collection, java.util.Iterator, java.math.BigDecimal, com.ibm.sample.daytrader.core.direct.*, com.ibm.sample.daytrader.entities.*, com.ibm.sample.daytrader.utils.*"
...
<jsp:useBean id="accountData"
    type="com.ibm.sample.daytrader.entities.AccountDataBean"
    scope="request" />
<jsp:useBean id="accountProfileData"
    type="com.ibm.sample.daytrader.entities.AccountProfileDataBean"
    scope="request" />
